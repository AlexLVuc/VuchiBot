    ...
    if(startup == False):
        ...
        if(timeset == "hour"):
            while(datetime.datetime.now().minute != 0):
                pass
        if(timeset == "halfhour"):
            while(datetime.datetime.now().minute != 30 & datetime.datetime.now().minute != 0):
                pass
        if(timeset == "quarterhour"):
            while(datetime.datetime.now().minute != 30 & datetime.datetime.now().minute != 0 & datetime.datetime.now().minute != 15 & datetime.datetime.now().minute != 45):
                pass
        if(timeset == "test"):
...
async def stockTracker(ticker: str, trade: str, timeset: str):
    ...
    while not client.is_closed:
        if(datetime.datetime.now().hour >= 16 & datetime.datetime.now().hour < 8):
